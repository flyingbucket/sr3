...
def prepare_and_save(file, sizes, out_path,add_ori):
...
def main(img_dir, out_path, add_ori,sizes):
    ...
    for file in tqdm(files, desc="Processing"):
        prepare_and_save(file, sizes, out_path,add_ori)
...
if __name__ == '__main__':
    ...
    main(args.path, args.out,args.add_ori, sizes)
